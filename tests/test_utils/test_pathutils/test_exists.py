...
class TestExists:
    ...
    def test_returns_true_for_directory(self, tempdir: Path) -> None:
    ...
    def test_returns_true_for_valid_symlink(self, tempdir: Path) -> None:
    ...
    def test_returns_true_for_broken_symlink(self, tempdir: Path) -> None:
        ...
        missing_target: Path = tempdir.joinpath(test_utils.get_random_name())
        link: Path = tempdir.joinpath(test_utils.get_random_name())
