...
class TestIsLinkF(test_utils.MakefilesTestBase):
    def test_returns_true_for_symlink_to_file(self) -> None:
    ...
    def test_returns_false_for_symlink_to_directory(self) -> None:
